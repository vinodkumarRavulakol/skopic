...
function StartCommunities(props) {
        ...
        useEffect(() => {
                ...
                axios
                        .request({
                                url: `http://dev.skopic.com:9090/skopicportal/jsonuser/tenant-map?mapStatus=IndexNear&requestCommunity=requestCommunity`,
                                method: "Get",
                                headers: {
                                        "Access-Control-Allow-Origin": "*",
                                        "Set-Cookie": Cookies.get("JSESSIONID"),
                                        ...
                                        <div className="StartCommunity">
                                                <div className={block}>
                                                        <div className="StartCommunity-Header">
                                                                <p>Start Community</p>
                                                                <button className="StartCommunity-Header--Close" onClick={props.close}>x</button>
                                                        </div>
                                                        <div className="StartCommunity-Body">
                                                                <div className="StartCommunity-Body--Intialinfo">
                                                                        ...
                                                                        <div className="StartCommunity-Body--CommunityType">
                                                                                <p>Community Type: <span className="indicatorImportant" >*</span></p>
                                                                                <div className="StartCommunity-CommunityOptions">
                                                                                        <div>
                                                                                                <input type="radio" name="communityType" value="public" checked="checked" />Public <span>Community accessible to all members</span>
                                                                                        </div>
                                                                                        <div>
                                                                                                <input type="radio" name="communityType" value="private" />Private <span>Members join Community by invitation or by request</span>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                                <div className="StartCommunity-Body--CommunityForm">
                                                                        ...
                                                                        <div className="EditInputfeild">
                                                                                <label className="EditName">Community Name:<span className="indicatorImportant" >*</span></label>
                                                                                <input type="text" value={name} onChange={(e) => setName(e.target.value)} />
                                                                                {errorMsg ? <p id="name" className="StartCommunityErrorMsg">Please enter this field.</p> : null}
                                                                        </div>


                                                                        <label className="EditNameDesc">Description:<span className="indicatorImportant" >*</span></label>
                                                                        <textarea className="EditTextfeild" value={description} onChange={(e) => setDescription(e.target.value)}  ></textarea>
                                                                        {errorMsg ? <p id="" className="StartCommunityErrorMsg">Please enter this field.</p> : null}

                                                                        <div className="EditInputfeild">
                                                                                <label className="EditName">Country :<span className="indicatorImportant" >*</span></label>
                                                                        ...
                                                                        <div className="EditInputSubfeild">
                                                                                <label className="EditName">Address:<span className="indicatorImportant" >*</span></label>
                                                                                <input type="text" value={tenantAddress} onChange={(e) => setTenantAddress(e.target.value)} />
                                                                        </div>

                                                                        <div className="EditInputSubfeild">
                                                                                <label className="EditName">City:<span className="indicatorImportant" >*</span></label>
                                                                                <input type="text" value={tenantCity} onChange={(e) => setTenantCity(e.target.value)} />
                                                                        </div>


                                                                        <div className="EditInputSubfeild">
                                                                                <label className="EditName">State :<span className="indicatorImportant" >*</span></label>
                                                                                <select className="EditSelectFeild">
                                                                        ...
                                                                        <div className="EditInputSubfeild">
                                                                                <label className="EditName">Zip Code:<span className="indicatorImportant" >*</span></label>
                                                                                <input type="text" value={tenantZipcode} onChange={(e) => setTenantZipcode(e.target.value)} />
                                                                        </div>
                                                        ...
                                                        <div className="StartCommunity-Footer">
                                                                ...
                                                                <div className="Submit">
                                                                        <Button variant="contained" onClick={OpenModalHandler}>Submit</Button><span>1 of 2</span>
                                                                </div>
                                                                {isOpen ? (
                                                                        <Dialog
                                                                                open={isOpen}
                                        ...
                                        <div className={className}>
                                                <div className="StartCommunity">
                                                        <div className="StartCommunity-Container">
                                                                ...
                                                                <div className="StartCommunity-Body">
                                                                        <div className="StartCommunity-Body--Intialinfo">
                                                                                <p>Email:<span className="indicatorImportant" >*</span> {communityData?.user?.email} </p>
                                                                                <p>Display Name:<span className="indicatorImportant" >*</span>   {communityData?.user?.displayName}</p>
                                                                        </div>
                                                                </div>
                                                                <div className="StartCommunity-Body--PersonalForm">
                                                                        <div className="EditInputfeild">
                                                                                <label className="EditName">First Name:<span className="indicatorImportant" >*</span></label>
                                                                        ...
                                                                        <div className="EditInputfeild">
                                                                                <div><label className="EditName">Phone :<span className="indicatorImportant" >*</span>  </label></div>
                                                                                <select className="EditSubSelectFeild">
                                                                                        <option value="1">+1</option>
                                                                                        <option value="2">+91</option>
                                                                                </select>
                                                                                <input type="text" className="PhoneTextFeild" value={phonenum} onChange={(e) => setPhonenum(e.target.value)} />
                                                                        </div>
                                                                ...
                                                                <div className="StartCommunity-Footer">
                                                                        <div className="CommunityGuidlines">
                                                                                <div>
                                                                                        <input type="checkbox" /> <span>By starting a community, you are agreeing to Skopic etiquette and User Guidelines<span className="indicatorImportant" >*</span></span>
                                                                                </div>
                                                                                <div>
                                                                                        <input type="checkbox" />  <span>By accepting to be a Primary Moderator, you are agreeing to Moderator Guidelines</span>
                                                                                </div>
                                                                        </div>
                                                                        <div className="Submit">
                                                                                <Button variant="contained" onClick={startCommunity}>Submit</Button><span>2 of 2</span>
                                                                        </div>
                                                                </div>
                                                        </div>
